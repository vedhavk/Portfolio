...
export default function Certifications() {
  return (
    ...
    >
      ...
      {/* ── Custom Keyframes for Infinite Loop Marquee ── */}
      ...
      <div className="w-full max-w-6xl mx-auto px-6 z-10 relative">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 w-full">
          ...
          <div className="w-full lg:w-[70%] overflow-hidden relative">
            ...
            <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#0a0a0a] to-transparent z-20 pointer-events-none hidden sm:block" />
            <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#0a0a0a] to-transparent z-20 pointer-events-none hidden sm:block" />
            ...
            <div className="w-full overflow-hidden py-4">
              <div className="animate-marquee-infinite">
                ...
                {/* 2nd Set (Duplicated for seamless infinite looping) */}
                {CERTIFICATES.map((cert, index) => (
                  <div
                    key={`set2-${index}`}
                    className="flex-shrink-0 flex flex-col items-center w-[290px] group"
